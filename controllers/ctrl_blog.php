...
class blog extends mainController
{
	...
	public function createAPI()
	{
		...
		if (!$blogID = $this->queryInsert($this->table, $params))
			$this->getResponse(503, "An Error Occure.");

		$this->dataArray = $this->getItemDetails($blogID);
		$this->getResponse(200, "Blog created successfully.");
	}
	...
	public function updateAPI()
	{
		...
		$this->getResponse(200, "Blog updated successfully.");
	}
	...
	public function deleteAPI()
	{
		...
		$this->getResponse(200, "Blog Deleted successfully.");
	}
	...
	public function unDeleteAPI()
	{
		...
		if (!$oldItemDetails['isDeleted'])
			$this->getResponse(503, "Blog Already Undeleted");
		...
		$this->getResponse(200, "Blog Un-Deleted successfully.");
	}
